...
<div class="left-side-bar" > 
    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="">
                <li>
                    <a href="dashboard.jsp" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-house"></span>
                        <span class="mtext">Dashboard</span>
                    </a>	
                </li>						
                <li>
                    <a href="response_data.jsp" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-textarea-resize"></span
                        ><span class="mtext">Response Data</span>
                    </a>							
                </li>						
                <li>
                    <a href="invitation_data.jsp" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-calendar4-week"></span
                        ><span class="mtext">Invitation Data</span>
                    </a>
                </li>
                <li>
                    <a href="user_data.jsp" class="dropdown-toggle no-arrow">
                        <span class="dw micon dw-user1"></span
                        ><span class="mtext">User Data</span>
                    </a>							
                </li>
                <li>
                    <a href="image_data.jsp" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-image"></span
                        ><span class="mtext">Image Data</span>
                    </a>							
                </li>
                <li>
                    <a href="index.jsp" class="dropdown-toggle no-arrow">
                        <span class="dw micon dw-logout"></span
