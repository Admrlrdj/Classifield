...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/Classifield/assets/fonts/icomoon/style.css">

        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="/Classifield/assets/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">

        <!-- Style -->
        <link rel="stylesheet" href="/Classifield/assets/css/style.css">
    ...
    <body>
        <div class="d-lg-flex half">
            <div class="bg order-1 order-md-2" style="background-image: url('/Classifield/assets/images/bg_1.jpg');"></div>
            <div class="contents order-2 order-md-1">
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-7">
                            <svg width="152" height="17" viewBox="0 0 152 17" fill="none"
                            ...
                            <h3 class="pt-5"><strong>Create your account!</strong></h3>
                            <br>
                            <form id="registrationForm" action="UserCtr" method="post">
                                <div class="form-group first">
                                    <label for="nama_instansi">Nama Instansi</label>
                                    <input type="text" class="form-control" name="nama_instansi" placeholder="Your Agency Name" id="nama_instansi">
                                </div>
                                <div class="form-group first">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" name="password" placeholder="Your Password"
                                               id="password" aria-describedby="password-addon">
                                ...
                                <div class="form-group last mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" name="confirmPassword" placeholder="Confirm Password"
                                               id="confirmPassword" aria-describedby="confirmPassword-addon">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group first">
                                    ...
                                    <input type="text" class="form-control" name="no_tlp" placeholder="Your Phone" id="no_tlp">
                                </div>

                                <input type="submit" value="Sign Up" class="btn btn-block btn-primary">

                                <p class="pt-2">Already have an account? <a class="text-primary"
        ...
        <!--<script src="/Classified/assets/js/popper.min.js"></script>-->
        <!--<script src="/Classified/assets/js/bootstrap.min.js"></script>-->
        <!--<script src="/Classified/assets/js/main.js"></script>-->
        <script>
